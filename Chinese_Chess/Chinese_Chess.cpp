...
// Chinese_Chess.cpp : Defines the class behaviors for the application.
//
...
// CChineseChessApp construction

CChineseChessApp::CChineseChessApp() noexcept
{
...
// The one and only CChineseChessApp object

CChineseChessApp theApp;


// CChineseChessApp initialization
...
BOOL CChineseChessApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_ChineseChessTYPE,
...
// CChineseChessApp message handlers
...
// CChineseChessApp customization load/save methods
